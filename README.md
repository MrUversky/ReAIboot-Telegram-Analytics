...
Проект имеет полнофункциональную систему автоматической документации, оптимизированную для работы с LLM.

### 🚀 Быстрый старт для ИИ
- **[LLM_README.md](docs/LLM_README.md)** - специальное руководство для искусственного интеллекта
- **[Dashboard](docs/DASHBOARD.md)** - централизованный обзор всей документации
- **[API документация](docs/technical/api/overview.md)** - все доступные эндпоинты

### 📊 Мониторинг и метрики
- **[Системное здоровье](docs/monitoring/system-health.md)** - статус всех компонентов
- **[Производительность](docs/metrics/performance.md)** - метрики работы системы

### 🔧 Для разработчиков
- **Автоматическое обновление:** `python .cursorrules/update_docs.py --all`
- **Анализ изменений:** `python .cursorrules/update_docs.py --dry-run --files src/`
- **Мониторинг:** `python .cursorrules/monitoring_integration.py --generate-report`
